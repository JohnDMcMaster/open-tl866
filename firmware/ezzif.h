/*
EZ ZIF (ezzif) is a library to set I/O using native DIP pin numbers and simple
functions You should not use low level APIs unless you know what you are doing
*/
